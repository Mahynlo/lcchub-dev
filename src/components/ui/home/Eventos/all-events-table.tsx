        ...
        <div className={cx`grid grid-cols-6 gap-4 border-l-0 md:border-l-2 
          ...
          <div className="col-start-1 col-end-2">
            <div className="font-mono grid grid-rows-2 gap-0 items-center justify-center text-center">
              ...
              <span className="text-2xl font-bold content-center">
                {day}
              </span>
              <span className={cx`row-span-1 border-b-2 md:border-b-0
              ${from_community ? 'border-b-green-400' : 'border-b-blue-400'}`}>{year}</span>
            </div>
          </div>
