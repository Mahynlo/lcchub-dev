        ...
        <div className="w-full">
          <section className="grid gap-6 md:grid-cols-[1fr_auto]">
            ...
            <div className="flex items-center gap-4">
              <Progress className="w-32" value={student.approvedCredits / student.requiredCredits * 100} />
              <div className="text-right">
                <div className="text-2xl font-bold">{Math.trunc(student.approvedCredits / student.requiredCredits * 100)}%</div>
          ...
          <section className="grid gap-6 md:grid-cols-2 lg:grid-cols-4`">
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{student.approvedCredits}</div>
                <p className="text-xs text-gray-500 dark:text-gray-400">de {student.requiredCredits} requeridos</p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="flex flex-row items-center justify-between pb-2">
              ...
              <CardContent>
                <div className="text-2xl font-bold">{student.requiredCredits - student.approvedCredits}</div>
                <p className="text-xs text-gray-500 dark:text-gray-400">para graduarse</p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">del periodo</p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="flex flex-row items-center justify-between pb-2">
                <CardTitle className="text-sm font-medium">Nivel de inglés</CardTitle>
                <BookIcon className="w-4 h-4 text-gray-500 dark:text-gray-400" />
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">{student.levelAndCycleEnglish.split('-')[0]}</div>
                <p className="text-xs text-gray-500 dark:text-gray-400">de 4</p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="flex flex-row items-center justify-between pb-2">
                <CardTitle className="text-sm font-medium">Créditos Culturales</CardTitle>
                <BookIcon className="w-4 h-4 text-gray-500 dark:text-gray-400" />
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">{student.cultCredits}</div>
                <p className="text-xs text-gray-500 dark:text-gray-400">de 4 requeridos</p>
              </CardContent>
            </Card>
          </section>
          </div>
